...
- **Dòng "Kể cả file không có nút tải về" trong `#planSelectModal` không đồng bộ với text email**: Đổi thành **"Sao chép được file không có nút tải về"** (`index.html`, cột Trọn đời, dòng 4) — đồng bộ với cùng tính năng trong email `plan_downgraded_by_admin`.
