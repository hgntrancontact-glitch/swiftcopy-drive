...
- **Checklist size display**: `#srcTotalSize` bị ẩn (display:none). `#clSizeInfo` hiện "Đã chọn: X.X GB (mov, pdf, doc...)" — size tổng + danh sách đuôi file thực tế (top 6 theo số lượng) sau khi deep scan xong
